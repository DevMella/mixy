...
import 'flowbite';
import one from '../../src/assets/sun.png';
import two from '../../src/assets/sun1.png';
import three from '../../src/assets/sun2.png';
import four from '../../src/assets/sun3.png';
import five from '../../src/assets/sun4.png';
import six from '../../src/assets/sun5.png';
import seven from '../../src/assets/sun6.png';
import eight from '../../src/assets/sun7.png';
...
const New = () => {
  ...
  return (
    <div className='cal' style={{ padding: '66px 46px' }}>
      <div>
        <p style={{ fontSize: '17px', fontWeight: '600', letterSpacing: '0.05em' ,fontSize:'34px' }}>Best Sellers</p>
        <h3 style={{ fontWeight: '100', color: 'gray'}}>Add bestselling products to weekly lineup</h3>
      </div>
      <div style={{ marginTop: '30px' }}>
        <div className='cat' style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '20px' }}>
          {productsData.map((product) => (
            <div key={product.id}>
              <div style={{ position: 'relative', borderRadius: '8px', padding: '10px', overflow: 'hidden', transition: 'transform 0.3s', backgroundColor: '#f6f6f6',}}onMouseEnter={(e) => {  const buttons = e.currentTarget.querySelectorAll('.action-button');
                  buttons.forEach((button) => button.style.display = 'block');}}
                onMouseLeave={(e) => {const buttons = e.currentTarget.querySelectorAll('.action-button');
                  buttons.forEach((button) => button.style.display = 'none'); }}>
                <div style={{ display: 'flex' }}>
                  <img src={product.image} style={{ width: '100%', borderRadius: '8px', transition: 'opacity 0.3s',height:'300px',objectFit:'cover' }} alt={product.name} />
                </div>
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', paddingTop: '12px' }}>
                ...
                <p style={{ fontWeight: '600', color: 'red', fontSize: '17px' }}>${product.price}</p>
              </div>
            </div>
          ))}
        </div>
