...
import 'flowbite';
import one from '../../src/assets/one (1).png';
import two from '../../src/assets/one (2).png';
import three from '../../src/assets/one (3).png';
...
const Seller = () => {
  ...
  return (
    <div className='gen' style={{ padding: '66px 46px' }}>
      <div>
